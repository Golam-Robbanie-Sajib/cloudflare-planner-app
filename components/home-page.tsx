    ...
    <div className="flex-grow flex flex-col items-center justify-center bg-slate-50">
      <div className="container mx-auto px-6 py-16 flex-grow flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Left Side: Animation (This is the correct section) */}
          <div>
            <AppAnimation />
          </div>
      ...
      <footer className="w-full text-center p-6 bg-slate-50">
        <Link href="/privacy-policy">
          <span className="text-sm text-slate-500 hover:text-slate-800 underline transition-colors">
            Privacy Policy
          </span>
        </Link>
      </footer>
